...
if __name__ == '__main__':
    ...
    if debug:
        ...
        cli_main([
            ...
            '--name=L_RASPP_mussels', '--num_classes=2', '--lr=0.0001',
            '--weight_decay=0.001', '--gradient_clip_val=0.5',
            '--max_epochs=10', '--log_every_n_steps=5',
            '--batch_size=4',
            '--benchmark', '--auto_select_gpus', '--gpus=-1', '--overfit_batches=1',
            '--initial_weights=scripts/mussels/train_output/checkpoints/L_RASPP_mussels/version_4/checkpoints/best-val_miou=0.8610-epoch=31-step=24063.pt',
        ])
    else:
        cli_main()
