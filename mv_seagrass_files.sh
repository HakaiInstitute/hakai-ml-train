...
bennet_bay_2018	/mnt/H/Internal/RS/UAV/Files/GulfIslands/2018/GINPR/BenBay_20180615_Processed_EMW_Orthomosaic/BenBay_20180615_Processed_EMW_Ortho_N83
...
choked_pass_2017	/mnt/H/Internal/RS/UAV/Files/Calvert/2017/20170723_ChokedPassageNorthBeach_U0234/Products/20170723_Calvert_Choked_Georef_MOS_U0234
...
selby_cove_2017	/mnt/H/Internal/RS/UAV/Files/GulfIslands/2017/20170720_SelbyCoveU0227/Products/GulfIslands_SelbyCoveNoGlare_mos_U0227
...
triquet_north_2016 /mnt/H/Internal/GIS/Vector/Marine/Marine_Biology/Eelgrass/CentralCoast/2016/20160705_CentralCoast_TriquetNorth_eelgrass
...
'fname="seagrass"; \
cp -u -v "$2.CPG" "./$1/$fname.CPG"; \
cp -u -v "$2.dbf" "./$1/$fname.dbf"; \
cp -u -v "$2.prj" "./$1/$fname.prj"; \
cp -u -v "$2.sbn" "./$1/$fname.sbn"; \
cp -u -v "$2.sbx" "./$1/$fname.sbx"; \
cp -u -v "$2.shp" "./$1/$fname.shp"; \
cp -u -v "$2.shp.xml" "./$1/$fname.shp.xml"; \
