...
def predict(seg_in, seg_out, weights, batch_size=4, crop_size=256, crop_pad=128):
    ...
    model = KelpSpeciesModel.load_from_checkpoint(str(weights), batch_size=batch_size, crop_size=crop_size,
                                                  padding=crop_pad)
    model.freeze()
...
if __name__ == '__main__':
    predict("/home/taylor/PycharmProjects/uav-classif/temp/image.tif",
            "/home/taylor/PycharmProjects/uav-classif/temp/image_kelp.tif",
            "/home/taylor/PycharmProjects/uav-classif/kelp_species/train_output/deeplabv3_kelp_species_200818.ckpt")
